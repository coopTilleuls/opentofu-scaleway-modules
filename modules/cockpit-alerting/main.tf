...
locals {
  ...
  oncall_24_7 = "https://oncall-prod-eu-west-0.grafana.net/oncall/integrations/v1/alertmanager/tiDwdbAxPr1h8wXk8VaRdmUxS/"
  oncall_7_5  = "https://oncall-prod-eu-west-0.grafana.net/oncall/integrations/v1/alertmanager/vAMEpDxK0IuIaUOhhVrQwC04n/"
  oncall_0_0  = "https://oncall-prod-eu-west-0.grafana.net/oncall/integrations/v1/alertmanager/k7WlOGjIBngKHq8mU9miSYSdU/"
